...
export class GuarantorEntity extends PersonEntity {
  ...
  static create(obj: IndividualEntity | CompanyEntity): GuarantorEntity {
    const emitter = new GuarantorEntity(obj.id);
